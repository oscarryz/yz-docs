...
// IsThunk marks variables that hold *Thunk[T] (boc call results in ScheduleFlatten context);
// the split-BocGroup pattern hoists these to the outer scope so they remain accessible after
// Schedule completes.
...
// SpawnExpr registers a thunk's Force on a BocGroup.
// Codegen emits:
...
type SpawnExpr struct {
	...
	Thunk        Expr   // the *Thunk[T]-returning expression
	StoreVar     string // if non-empty: assign forced value to this var
