...
## Status
- **101 golden + 25 error conformance tests passing** (+ multi_root + subdir_coexist examples + 3 macro TestMacros cases + macro_debug example) — `go test -race ./...` passes (test 51 has pre-existing timing flakiness)
